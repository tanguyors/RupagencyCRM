...
if (!process.env.DATABASE_URL) {
  ...
  console.log('💡 Ajoutez DATABASE_URL dans vos variables d\'environnement');
  process.exit(1);
}
...
async function setupDatabase() {
  ...
  try {
    ...
    console.log(`   - Email: admin@rupagency.com`);
    console.log(`   - Mot de passe: password123`);
    console.log(`   - URL: ${process.env.REACT_APP_API_URL || 'http://localhost:5000'}`);
