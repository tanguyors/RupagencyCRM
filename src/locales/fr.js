const fr = {
  ...
  crmForClosers: 'CRM pour closers',
  ...
  sectorStats: 'Statistiques par secteur',
  ...
  relatedCalls: 'Appels liés',
  relatedAppointments: 'Rendez-vous liés',
  ...
  salesCall: 'Appel commercial',
  supportCall: 'Appel support',
